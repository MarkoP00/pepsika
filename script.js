...
// const pepsiImage = document.querySelectorAll('.imageOne img');
// const calImage = document.querySelectorAll('.imageTwo img');
// const specialClass = document.querySelector('.specialClass')

// pepsiImage.forEach((img) => {
//     img.addEventListener('click', ()=> {
//         calImage.forEach((cal)=> {
//             cal.classList.add('specialClass');
//         });
//     });
// });